 ...
 */
class Profile extends \Lef\UserBundle\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Lef\\UserBundle\\Entity\\Profile' . "\0" . 'id', '' . "\0" . 'Lef\\UserBundle\\Entity\\Profile' . "\0" . 'gender', '' . "\0" . 'Lef\\UserBundle\\Entity\\Profile' . "\0" . 'birthday', '' . "\0" . 'Lef\\UserBundle\\Entity\\Profile' . "\0" . 'updatedAt');
        }
